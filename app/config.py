...
class Settings:
    ...
    torbox_base_url: str = os.getenv("TORBOX_BASE_URL", "https://api.torbox.app/v1")
    ...
    qbit_app_version: str = os.getenv("QBIT_APP_VERSION", "v4.6.5")
    qbit_webapi_version: str = os.getenv("QBIT_WEBAPI_VERSION", "2.9.3")
    ...
    save_path_base: str = os.getenv("SAVE_PATH", os.getenv("DOWNLOAD_DIR", "/downloads"))
    # SQLite state file.
